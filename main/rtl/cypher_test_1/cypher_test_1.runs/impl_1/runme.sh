...
HD_PWD='C:/Users/Admin/cypher_test_1/cypher_test_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TRNG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TRNG.tcl -notrace
