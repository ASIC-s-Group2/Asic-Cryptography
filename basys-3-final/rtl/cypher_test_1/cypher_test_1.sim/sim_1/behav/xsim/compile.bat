...
REM
REM Generated by Vivado on Wed Jul 30 14:15:45 -0700 2025
...
echo "xvlog --incr --relax -L uvm -prj TRNG_vlog.prj"
call xvlog  --incr --relax -L uvm -prj TRNG_vlog.prj -log xvlog.log
