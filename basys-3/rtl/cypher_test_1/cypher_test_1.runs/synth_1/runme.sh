...
HD_PWD='C:/Users/Admin/cypher_test_1/cypher_test_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TRNG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TRNG.tcl
